...
[x: string]: any;
 ...
 public email:any;
  ...
  ngOnInit() {
    ...
    this.http.get(`https://backend-survey.onrender.com/form/form/${this.surveyID}`).subscribe((response)=> {
  ...
  saveForm(form:NgForm) {
    ...
    this.http.post('https://backend-survey.onrender.com/response/', finalObj, {
      headers: headers1
